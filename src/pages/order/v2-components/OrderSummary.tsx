...
export function OrderSummary({
  ...
  const subtotal = transaction.totalPrice ? transaction.totalPrice - (transaction.discount || 0) - (transaction.deliveryCharge || 0) : 0;
  ...
  return (
    <div className="space-y-4">
      <Card className="shadow-sm border-gray-200">
        <CardContent className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="discount" className="text-xs flex items-center gap-2 font-semibold text-gray-700">
            ...
            <Input
              ...
              onChange={(e) =>
                onTransactionChange({ ...transaction, discount: parseFloat(e.target.value) || 0 })
              }
          ...
          {/* Delivery Charge */}
          <div className="space-y-2">
            <Label htmlFor="delivery" className="text-xs flex items-center gap-2 font-semibold text-gray-700">
          ...
          {/* Paid Amount */}
          <div className="space-y-2">
            <Label htmlFor="paid" className="text-xs flex items-center gap-2 font-semibold text-gray-700">
            ...
            <Input
              ...
              step="0.01"
              placeholder="0.00"
              value={transaction.paid || 0}
              onChange={(e) =>
                onTransactionChange({ ...transaction, paid: parseFloat(e.target.value) || 0 })
              }
      ...
      <Card className="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-700 border-0 shadow-lg">
        <CardContent className="p-5 space-y-3 text-white">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium">৳{(transaction.deliveryCharge || 0).toFixed(2)}</span>
          </div>

          <div className="border-t border-white/20 pt-3 mt-3">
            <div className="flex justify-between text-lg font-bold">
              <span>Total</span>
              <span className="text-white">৳{(transaction.totalPrice || 0).toFixed(2)}</span>
            </div>
          </div>
      ...
      <Button
        ...
        className="w-full h-12 text-base font-semibold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-200 hover:-translate-y-0.5"
        size="lg"
      >
        {isSubmitting ? (
          <>Creating Order...</>
