    ...
    <div className="relative w-full">
      ...
      {isOpen &&
        createPortal(
          <div
            ref={dropdownRef}
            className="fixed z-[70] pointer-events-auto bg-white border border-gray-200 rounded-lg shadow-lg max-h-80 overflow-hidden"
            style={{
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {customerItem.orderCount !== undefined && (
                            <p className="text-xs text-gray-400 mt-0.5">
                              {customerItem.orderCount} order{customerItem.orderCount !== 1 ? 's' : ''}
                            </p>
                          )}
                        </div>
                      </div>
