...
const UpdateCampaignForm: React.FC = () => {
  ...
  useEffect(() => {
    if (!!campaign) {
      ...
      setDeliveryDiscountType(campaign?.deliveryDiscountType ?? "none");
      setDeliveryDiscountAmount(String(campaign?.deliveryDiscountAmount ?? 0));
    }
  }, [campaign]);
  ...
  if (loading) {
    return (
      <MainView title='Update Campaign'>
  ...
  return (
    <MainView title='Update Campaign'>
      <div className='bg-gray-50/60 px-4 py-6 sm:px-6 lg:px-8'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-sm text-gray-500 mt-1'>
              Edit campaign details, discounts, and product selections.
            </p>
          </div>
                  ...
                  <Section icon={<Settings className='w-4 h-4' />} title='Status'>
                    <Field label='Campaign Status'>
                      <Select
                        ...
                        onValueChange={(v) => setActive(Boolean(v))}>
                        <SelectTrigger className='h-10 text-sm rounded-lg border-gray-200'>
