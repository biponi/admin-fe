...
export default function CustomerCouponsPage() {
  ...
  const assignmentOptions = [
    ...
    },
    {
      ...
      description: "Target customer segments like inactive, high-value, or new customers",
      icon: UserPlus,
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Customer Coupons</h1>
          ...
          <Tabs defaultValue="view">
            ...
            <TabsContent value="search" className="space-y-4">
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>Search for a customer by phone number to see their assigned coupons</p>
                <Button
                  className="mt-4"
                  onClick={() => navigate("/coupons/customer/search")}
                >
