...
export const ProductAdjustmentHistory: React.FC<ProductAdjustmentHistoryProps> = ({
  open,
  onOpenChange,
  productId,
  productName,
                ...
                <TableRow key={adjustment.id}>
                  <TableCell className="text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div>{dayjs(adjustment.timestamps.createdAt).format("MMM DD, YYYY")}</div>
                        <div className="text-xs text-muted-foreground">
                          {dayjs(adjustment.timestamps.createdAt).format("h:mm A")}
                        </div>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm">
                        <div className="font-medium">{adjustment.adjustedBy.userName}</div>
                        <div className="text-xs text-muted-foreground">
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="font-mono text-sm">
                    ...
                    {getQuantityDisplay(adjustment)}
                    <span className="mx-2">→</span>
                    <span className="font-semibold">{adjustment.newQuantity}</span>
                  </div>
                </div>
                <Separator />
                <div>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {dayjs(adjustment.timestamps.createdAt).format("MMM DD, h:mm A")}
                  </span>
                </div>
              </CardContent>
            </Card>
