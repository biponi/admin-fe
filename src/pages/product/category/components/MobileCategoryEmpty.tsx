...
interface MobileCategoryEmptyProps {
  type: "no-categories" | "no-filtered-results" | "loading" | "error";
...
const MobileCategoryEmpty: React.FC<MobileCategoryEmptyProps> = ({
  type,
    ...
    switch (type) {
      case "no-categories":
        return {
          ...
          description: "Start organizing your products by creating your first category. Categories help you organize and manage your product catalog effectively.",
      ...
      case "no-filtered-results":
        return {
          ...
          description: `No categories match your current filters${filterText ? ` for "${filterText}"` : ""}. Try adjusting your filters or search criteria.`,
      ...
      case "loading":
        return {
          ...
          description: "Please wait while we fetch your category data...",
      ...
      case "error":
        return {
          ...
          description: "We couldn't load your categories. Please check your connection and try again.",
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center min-h-[50vh] sm:hidden">
      ...
      <div className="mt-8 space-y-3 w-full max-w-sm mx-auto">
        ...
        {/* Secondary Actions */}
        {type === "no-categories" && !hasCreatePermission && (
          <div className="pt-4">
            <p className="text-xs text-gray-500 leading-relaxed">
              Categories will appear here once they are created. Contact your administrator if you need to create categories.
            </p>
          </div>
        )}
      ...
      {type === "no-categories" && (
        <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-blue-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-blue-800">Why Categories?</span>
          </div>
          <p className="text-xs text-blue-700 leading-relaxed">
            Categories help organize products, improve navigation, and make it easier for customers to find what they're looking for.
          </p>
        </div>
      )}
...
export default MobileCategoryEmpty;