/**
 * FraudDetectionContent Component
 * Displays fraud detection analysis content (extracted from FraudDetectionDrawer)
 */
...
export const FraudDetectionContent: React.FC<FraudDetectionContentProps> = ({
  fraudDetection,
}) => {
  ...
  return (
    <div className='space-y-4 overflow-y-auto max-h-[calc(100vh-50px)]'>
      {/* Risk Level Card */}
          ...
          <Card>
            <CardContent className='p-4'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-3 gap-3'>
                ...
                {fraudDetection.metrics.lastCancellationDate !== undefined && (
